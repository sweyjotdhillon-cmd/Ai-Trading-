  ...
  return (
    ...
    >
      <View style={tw`flex-1 justify-center items-center bg-black/60 px-4`}>
        ...
        <View style={tw`w-full max-w-md bg-[#14161C] border border-white/10 rounded-2xl shadow-2xl overflow-hidden`}>
          <View style={tw`flex-row items-center justify-between p-4 border-b border-white/5`}>
            ...
            <TouchableOpacity onPress={onClose} style={tw`p-2 hover:bg-white/5 rounded-full`}>
